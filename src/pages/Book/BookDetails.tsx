        ...
        <div className='py-12'>
            {isLoading ? (<p>Loading....</p>) : error? (<p>Something went wrong!</p>) : (
                <div className='grid md:grid-cols-4 gap-8'>
                    ...
                    {/* left content  */}
                    <div className='max-w-[300px] w-full max-h-[450px] h-full hover:scale-105 duration-300 shadow-xl shadow-black sticky top-24 hidden md:block'>
                        <img className='h-full' src={image} alt="" />
                    </div>

                    {/* middle content  */}
                    <div className=' px-2 md:px-0 md:col-span-2'>
                        <div>
